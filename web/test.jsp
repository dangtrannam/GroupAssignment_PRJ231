...
<body>
  <header>
    <div class="container">
      ...
      <nav role="navigation"
        class="navbar navbar-dark navbar-expand-md bg-success border rounded navigation-clean-search">
        <div class="container"><a class="navbar-brand" href="home.html">Luyện thi bằng lái</a>
          ...
          <div class="collapse navbar-collapse" id="navcol-1">
            ...
            <button class="btn btn-primary btn-sm login" type="button">Đăng nhập</button>
            <button class="btn btn-primary btn-sm login" type="button">Đăng xuất</button>
          </div>
        </div>
                  ...
                  <div class="row d-block ndcauhoi" id="1">
                    <div class="row">
                      ...
                      <div class="col-12" style="text-align: justify;">
                        <strong>Phần của đường bộ được sử dụng cho các phương tiện giao thông qua lại là gì ?</strong>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="cautraloi">
                          <label class="checkbox-inline">
                            <input type="radio" class="answer" name="1[]" value="Phần mặt đường và lề đường"> 1- Phần
                            mặt
                            đường và lề đường.
                          </label>
                        </div>
                        <div class="cautraloi">
                          <label class="checkbox-inline">
                            <input type="radio" class="answer" name="1[]" value="Phần mặt đường và lề đường"> 2- Phần
                            đường xe chạy.
                          </label>
                        </div>
                        <div class="cautraloi">
                          <label class="checkbox-inline">
                            <input type="radio" class="answer" name="1[]" value="Phần mặt đường và lề đường"> 3- Phần
                            đường xe cơ giới.
                          </label>
                        </div>
                      </div>
                  ...
                  <div class="row d-none ndcauhoi" id="2">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="cautraloi">
                          <label class="checkbox-inline">
                            <input type="radio" class="answer" name="1[]" value="Phần mặt đường và lề đường"> ádfádf
                          </label>
                        </div>
                        <div class="cautraloi">
                          <label class="checkbox-inline">
                ...
                <div>
                  <div>
                    <ul class="pager d-flex justify-content-around">
                      <li class="previous cautruoc btn btn-primary float-left ">Câu trước</li>
                      <li class="next causau btn btn-primary float-right">Câu sau</li>
                    </ul>
                  </div>
                </div>
              </div>
